<template>
  <el-dialog title="招生老师" :close-on-click-modal="false" :visible.sync="visible" append-to-body width="600px">
...
<script>
   import { zsTeacherAuthList } from '@/api/sys'
  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        zsTeacherAuthList(this.pageIndex, this.pageSize, this.dataForm.username).then(res => {
