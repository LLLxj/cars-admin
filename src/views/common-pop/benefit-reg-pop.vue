...
<script>
  import { getBenefitRegList } from '@/api/benefit'
  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        // 查询
        getBenefitRegList(this.pageIndex, this.pageSize, this.dataForm.stuName, this.dataForm.stuPhone).then(res => {
      ...
      selectHandle () {
        ...
        this.$emit('benefitRegPop-pop-event', this.dataForm.regId,this.dataForm.regNo,this.rowData)
        this.visible = false
      },
      // 取消
      cancleHandle () {
