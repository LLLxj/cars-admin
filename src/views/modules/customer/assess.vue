    ...
    <el-container>
      ...
      <el-main>
        ...
        <el-table :data="dataList" border stripe v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;" id="dataListUser">
          ...
          <el-table-column header-align="center" align="center" label="商品照片" width="80">
          ...
          <el-table-column header-align="center" align="center" label="驾驶证照片" width="120">
            <template slot-scope="scope">
							<div v-if="scope.row.driveImage && scope.row.driveImage.image !== ''">
              	<img :src="scope.row.driveImage.image" style="width:80px" alt="">
							</div>
							<span v-else>-</span>
            </template>
          </el-table-column>
