        ...
        <el-table :data="dataList" border stripe v-loading="dataListLoading" style="width: 100%;" id="dataListUser">
          ...
          <el-table-column fixed="right" header-align="center"  align="center" width="200" label="操作">
            <template slot-scope="scope">
              ...
              <el-button v-if="isAuth('deal:wares:success') && scope.row.status === 2 && scope.row.onlineStatus === 1 && scope.row.sellStatus === 0" type="text" size="small" @click="manageHandle(scope.row.dealWaresId, 4)">通过</el-button>
