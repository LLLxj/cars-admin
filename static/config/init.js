...
;(function() {
  var resList = {
    icon: window.SITE_CONFIG.cdnUrl + '/static/img/index.ico',
    css: [
    ...
    js: [
      ...
      // 插件 - echarts
      window.SITE_CONFIG.cdnUrl + '/static/plugins/echarts-4.2.0-rc.2/echarts.common.min.js',
      window.SITE_CONFIG.cdnUrl + '/static/plugins/echarts-4.2.0-rc.2/walden.js',
      // 插件 - ueditor
