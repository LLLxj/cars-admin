...
<script>
  ...
  import { dyTeacherDayInfo, dyTeacherWeekInfo, dyTeacherMonthInfo } from '@/api/regSchoolLog'
  ...
  export default {
    ...
    methods: {
      ...
      loadInfoDay () {
        ...
        dyTeacherDayInfo(this.chooseTime).then(res => {
      ...
      loadInfoWeek () {
        this.dataListLoading = true
        dyTeacherWeekInfo(this.chooseTime).then(res => {
          if(res.data && res.data.code === 0){
            this.dataList = res.data.data
          }
          this.dataListLoading = false
      ...
      loadInfoMonth () {
        this.dataListLoading = true
        dyTeacherMonthInfo(this.chooseTime).then(res => {
          if(res.data && res.data.code === 0){
            this.dataList = res.data.data
          }
          this.dataListLoading = false
